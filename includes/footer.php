<footer class = "navbar-dark bg-dark flex-wrap mt-auto">
    <div class="container">
        ...
        <ul class="nav justify-content-center border-bottom border-top text-center mb-5">
            ...
            <li class = "nav-item">
                <a class = "nav-link active text-white" href = "https://www.linkedin.com/in/george-tsintilas-071ab6325/">
                    <i class="bi bi-linkedin"></i>
                    My Linkedin profile</a>
            </li>
        </ul>
        <p class="text-center text-white">George Tsintilas 2024</p>
    </div>
</footer>